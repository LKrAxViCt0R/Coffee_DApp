...
async function main() {
  ...
  await contract.connect(from1).buyCoffee("Nitin","Very nice coffee", amount);
  await contract.connect(from2).buyCoffee("Subs","It's a great coffee", amount);
  await contract.connect(from3).buyCoffee("Anshu","My favorite coffee", amount);
